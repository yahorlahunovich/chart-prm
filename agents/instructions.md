...
5. **Project Context**: The primary objective is Process Reward Modeling (PRM) for chart question answering using Qwen2.5-VL-3B. Follow the pipeline in `README.md`. We strictly use a balanced subset of 500 **reasoning questions** from CharXiv (and 100 for evaluation). We completely ignore descriptive questions.
