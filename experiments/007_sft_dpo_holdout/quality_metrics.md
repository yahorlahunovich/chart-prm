...
- **Wrong committed answer** (hallucination proxy): KTO commits a wrong final value with GT never mentioned least often (30%). SFT→DPO does this most (53%). This is not a visual judge of chart entities.
