...
\small
Architected the core ChartPRM pipeline on \textbf{CharXiv}, engineered custom VLM alignment trainers, and authored the foundational report.
\begin{itemize}
  ...
  \item \textbf{AI usage summary:} Used \textbf{Antigravity} and \textbf{Cursor} (powered by Gemini and Claude) as AI coding assistants for scaffolding scripts, resolving CUDA/VRAM driver bugs on Kaggle, and refactoring pipelines. I conceptualized the small-data hypothesis, designed the experimental protocols, formulated the analytical narratives, and verified all empirical results.
\end{itemize}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.485\textwidth}
